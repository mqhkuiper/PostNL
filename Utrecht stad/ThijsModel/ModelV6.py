...
# 3) candidate depots
# ============================================================
# restrict each route to its nearest depots to reduce model size
...
for i in I:
    # select depots with known distances to route i
...
if m.SolCount > 0:
    ...
    # WRITE TO EXCEL
    # --------------------------------------------------------
    out_path = os.path.join(SCRIPT_DIR, "solution_US_new.xlsx")
